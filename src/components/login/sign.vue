                    ...
                    <div class="sign_form_container">
                        <div class="l_login_box">
                            ...
                            <div class="login_title_box">
                                <p class="login_left_info">注册</p>
                                <div class="login_right_info" @click="toLoginPage()">
                                    <span>登陆</span>
                                    <img src="../../../static/img/home/point.png" alt="">
                                </div>
                            </div>
                            <div class="input_box">
                                <div class="user_name" :class="[isShow2 == 1 ? className : className2]">
                                    <input type="text" name="username" v-model="userName"
                                           placeholder="用户名" maxlength="24" autocomplete="OFF">
                                </div>
                                <div class="err_psd_msg" v-show="isShow1">
                                    <p>{{psdMsg}}</p>
                                </div>
                                <div class="phone_name" :class="[isShow1 == 1 ? classPhone : classPhone2]">
                                    <input type="number" name="phone" v-model="phone" maxlength="11"
                                           placeholder="手机号" autocomplete="OFF">
                                    <div class="get_code_box" @click="getCode()">
                                        <p class="getCode">
                                            {{getCodeMsg}}
                                        </p>
                                    </div>
                                </div>
                                <div class="err_msg" v-show="isShow2">
                                    <p>{{errorMsg}}</p>
                                </div>
                                <div class="code_name" :class="[isShow2 == 1 ? classPsd : classPsd2]">
                                    <input type="number" name="code_name" v-model="codeName"
                                           placeholder="输入短信验证码" maxlength="6" autocomplete="OFF">
                                </div>
                                ...
                                <div class="pass_word" :class="[isShow2 == 1 ? classPsd : classPsd2]">
                                    <input type="password" name="password" v-model="passWord"
                                           placeholder="设置密码（不少于8位字符）" maxlength="12" autocomplete="OFF">
                                </div>
                                <div class="err_psd_msg" v-show="isShow2">
                                    <p>{{psdMsg}}</p>
                                </div>
                                <div class="submit_login" @click="toSign()">
                                    确认修改
                                </div>

                            </div>
                            <div class="success_alert" v-show="isSuccess">
                                <div class="success_content">
                                    <img src="../../../static/img/home/correct.png" alt="">
                                    <p>修改密码成功</p>
                                </div>
        ...
        methods: {
            ...
            toSign(){
                ...
                if(this.userName == ''){
                    ...
                    this.className = 'user_name user_name_border';
                    return;
                }else if(!(/^1[34578]\d{9}$/.test((this.uesrName)))){
...
<style lang="less" scoped>
    ...
    .phone_name>input,.pass_word>input{
        width:390px;
        padding-left:20px;
        margin:0 auto;
        line-height:40px;
